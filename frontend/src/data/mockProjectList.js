...
export const mockProjectList = [
  project({
    ...
    description: '인디 개발자와 소규모 팀을 위한 실시간 초경량 웹 프로덕트 애널리틱스.',
    category: '개발자 도구',
  ...
  project({
    ...
    description: 'AI 프롬프트 체이닝과 버전 관리를 위한 협업 워크스페이스.',
    category: 'AI',
  ...
  project({
    id: 'prj_310',
    title: 'LogStack Pro',
    description: '분산 서버 환경의 로그를 실시간으로 스트리밍하고 AI 기반 이상 징후를 탐지합니다.',
    category: '개발자 도구',
    categorySlug: 'developer-tools',
    likes: 694,
    comments: 19,
  ...
  project({
    id: 'prj_311',
    title: 'GrowthPulse',
    description: '사이드 프로젝트의 전환율과 이탈률을 한눈에 보여주는 마케팅 분석 대시보드.',
    category: '마케팅',
  ...
  project({
    ...
    description: '마크다운 기반의 미니멀리스트 1인 개발자용 칸반 보드 및 스프린트 트래커.',
    category: '생산성',
  ...
  project({
    id: 'prj_306',
    title: 'CodeSnap Pro',
    description: 'Turn beautiful code snippets into shareable images for your next launch.',
    category: '개발자 도구',
    categorySlug: 'developer-tools',
    likes: 775,
    comments: 31,
  ...
  project({
    id: 'prj_315',
    title: 'PixelMuse AI',
    description: '프롬프트 한 줄로 아이콘·일러스트를 생성하는 AI 이미지 툴.',
    category: 'AI',
    categorySlug: 'ai-service',
    likes: 380,
    comments: 11,
  ...
  project({
    id: 'prj_316',
    title: 'ClipCast Studio',
    description: '유튜브 롱폼 영상을 숏폼 클립으로 자동 편집해주는 서비스.',
    category: '엔터테인먼트',
    categorySlug: 'content-entertainment',
    likes: 365,
    comments: 17,
    views: 5200,
  }),
  project({
    id: 'prj_317',
    title: 'TinyCRM',
    description: '1인 프리랜서를 위한 초경량 고객 관리 스프레드시트 대체 툴.',
    category: '생산성',
    categorySlug: 'productivity-work',
    likes: 288,
    comments: 4,
