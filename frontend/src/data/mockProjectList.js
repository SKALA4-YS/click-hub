...
export const mockProjectList = [
  ...
  project({ id: 'prj_302', title: 'PromptCraft Studio', description: 'AI 프롬프트를 팀 단위로 관리하고 버전을 비교할 수 있는 워크스페이스.', category: '개발자 도구', categorySlug: 'developer-tools', likes: 942, comments: 14, views: 15230 }),
  ...
  project({ id: 'prj_305', title: 'FlowBoard Kanban', description: '마크다운 기반의 미니멀리스트 1인 개발자용 칸반 보드 및 스프린트 트래커.', category: '생산성', categorySlug: 'productivity-work', likes: 420, comments: 6, views: 1100 }),
  project({ id: 'prj_304', title: 'GitPulse Activity', description: 'GitHub 커밋 히스토리를 시각화해 꾸준함을 보여주는 잔디밭 대체 위젯.', category: '개발자 도구', categorySlug: 'developer-tools', likes: 480, comments: 8, views: 1100 }),
  project({ id: 'prj_306', title: 'CodeSnap Pro', description: '코드 스니펫을 예쁜 이미지로 내보내는 macOS 유틸리티.', category: '개발자 도구', categorySlug: 'developer-tools', likes: 775, comments: 5, views: 700 }),
