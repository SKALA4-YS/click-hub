 ...
 * 프론트엔드(SPA) 콜백 URL로 302 리다이렉트한다. Access Token은 서버 로그와 referrer에
 * 남기 쉬운 query string 대신 URL fragment로 전달한다. Fragment는 브라우저가 서버로 보내지
 * 않으며, 프론트는 즉시 sessionStorage로 옮긴 뒤 주소창에서 제거한다.
 */
@Component
